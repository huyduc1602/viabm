<?php
    ...
    $title = 'NẠP TIỀN QUA VÍ ZALO PAY | '.$CMSNT->site('tenweb');
...
<div class="content-i">
    <div class="content-box">
            ...
            <div class="col-sm-12">
                <div class="element-wrapper">
                    <div class="element-box text-center">
                        <img src="https://upload.wikimedia.org/wikipedia/vi/7/77/ZaloPay_Logo.png" height="100px;" />
                        <br><br>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="element-wrapper">
                    <h6 class="element-header"><?=langByVn('LỊCH SỬ NẠP ZALO PAY');?></h6>
