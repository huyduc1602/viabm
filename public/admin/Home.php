...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="alert alert-dark">
            ...
            <ul>
                <li>29/10/2021: Tuỳ chọn lọc trùng khi thêm tài nguyên.</li>
                <li>27/10/2021: Fix hiển thị sản phẩm API.</li>
                <li>24/10/2021: Sắp xếp hiển thị sản phẩm API.</li>
                <li>24/10/2021: Nạp tiền tự động qua TBBank.</li>
            </ul>
