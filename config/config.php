...
class CMSNT
{
    ...
    function connect()
    {
        ...
        {
//            Host
           $this->ketnoi = mysqli_connect('localhost', 'ystfcwlb_viabm', '34zQ[kB7qehq', 'ystfcwlb_viabm') or die ('Vui lòng kết nối đến DATABASE');
//            Local
            // $this->ketnoi = mysqli_connect('localhost', 'root', '', 'ystfcwlb_viabm') or die ('Vui lòng kết nối đến DATABASE');
